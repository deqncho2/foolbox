...
class Adversarial(object):
    ...
    def __new_adversarial(self, image, predictions, in_bounds):
        ...
        # print(self.__best_distance)
        # print('---------')
        if (in_bounds and self.__best_distance <= distance and self.__best_distance.value != np.inf) \
                or (in_bounds and self.__best_distance > distance and self.__best_distance.value == np.inf):
    ...
    def __is_adversarial(self, image, predictions, in_bounds):
        ...
        #print(self.normalized_distance(image))
        # print(self.__threshold)
